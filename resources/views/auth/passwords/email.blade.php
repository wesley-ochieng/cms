                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="{{ route('password.email') }}">
                                    @csrf
                                    <div class="form-group"><input class="form-control form-control-user @error('email') is-invalid @enderror" type="email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address..." name="email">
                                ...
                                <div class="text-center">
                                    <hr><a class="small" href="{{ route('register') }}">Create an Account!</a>
                                </div>
