    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h2 class="text-uppercase section-heading" style="font-family: 'Cinzel Decorative', cursive;">Contact Edenep</h2>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 item text">
                    <h3>Eden events</h3>
                    <p class="font-raleway">&nbsp;Eden Planners has built an impressive events repertoire and clientele without compromising its principles and quality.</p>
                </div>
