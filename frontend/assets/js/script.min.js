$(document).ready(function () {
    ...
    (function (t, e) {
        ...
        "function" == typeof define && define.amd
            ? define(["ev-emitter/ev-emitter"], function (r) {
                  return e(t, r);
              })
        ...
        return (
            ...
            (i.prototype.progress = function (t, e, r) {
                this.progressedCount++,
                    ...
                    this.options.debug && a && a.log("progress: " + r, t, e);
            }),
    ...
    (function (t) {
        ...
        function (t, e, r) {
            ...
            var i =
                ...
                g = { IDLE: "IDLE", FILTERING: "FILTERING", SORTING: "SORTING", SHUFFLING: "SHUFFLING" };
        },
        function (t, e, r) {
            "use strict";
            function i(t, e) {
                ...
                l = (function () {
                    function t() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ".filtr-container",
                            r = arguments[1];
                        i(this, t), (this.$node = a(e)), (this.props = { FilterItems: this.getFilterItems(r), w: this.getWidth(), h: 0 }), this.$node.css({ padding: 0, position: "relative" }), this.updateFilterItemsDimensions();
                    }
                    return (
                        s(t, [
                            {
                ...
                f = (function () {
                    function t() {
                        ...
                        new n.a(this, this.options.controlsSelector),
                            (this.props = { filterizrState: l.a.IDLE, searchTerm: "", sort: "index", sortOrder: "asc", FilterContainer: s, FilterItems: s.props.FilterItems, FilteredItems: [] }),
                            this.bindEvents(),
            ...
            var n = r(0),
                ...
                a = (function () {
                    function t(e) {
                        ...
                        i(this, t), (this.props = { Filterizr: e, selector: r }), this.setupFilterControls(), this.setupShuffleControls(), this.setupSearchControls(), this.setupSortControls();
                    }
                    return (
                        o(t, [
                            {
            ...
            e.a = function (t) {
                var e = t.props,
                    ...
                    l = n.map(function (t, e) {
                        ...
                        e % o == 0 && e >= o && s++;
                        var c = e - o * s;
                        return (a[c] += u), { left: c * l, top: i(n, o, e) };
                    });
                return (
                    r.updateHeight(
                        Math.max.apply(
        ...
        function (t, e, r) {
            ...
            (i.prototype = {
                ...
                splitNode: function (t, e, r) {
                    return (t.used = !0), (t.down = { x: t.x, y: t.y + r, w: t.w, h: t.h - r }), (t.right = { x: t.x + e, y: t.y, w: t.w - e, h: r }), t;
                },
    ...
    (function (t) {
        ...
        t('a.js-scroll-trigger[href*="#"]:not([href="#"])').click(function () {
            if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                var e = t(this.hash);
                if ((e = e.length ? e : t("[name=" + this.hash.slice(1) + "]")).length) return t("html, body").animate({ scrollTop: e.offset().top - 57 }, 1e3, "easeInOutExpo"), !1;
            }
        }),
            t(".js-scroll-trigger").click(function () {
                t(".navbar-collapse").collapse("hide");
            }),
            t("body").scrollspy({ target: "#mainNav", offset: 57 });
        var e = function () {
            t("#mainNav").offset().top > 100 ? t("#mainNav").addClass("navbar-shrink") : t("#mainNav").removeClass("navbar-shrink");
        };
        e(),
            t(window).scroll(e),
...
$("ul.filters li a").on("click", function () {
    ...
    if ("all" == t) $("div.gallery-pt--body>.item").show();
        ...
        e.parent().height(e.parent().height()),
            e
                .slideUp(500, function () {
                    $(this)
                        .find('img[data-album!="' + t + '"]')
                        .closest("div.item")
                        .hide()
                        .parent()
                        .find('img[data-album="' + t + '"]')
